param(
	[string]$project = ".\src\SAML2.Logging.CommonLogging\SAML2.Logging.CommonLogging.csproj",
	[string]$solution = ".\src\SAML2.Logging.CommonLogging.sln",
	[string]$assemblyInfoFile = ".\src\SAML2.Logging.CommonLogging\Properties\AssemblyInfo.cs",
	[string]$nuspecFile = ".\src\SAML2.Logging.CommonLogging\SAML2.Logging.CommonLogging.nuspec"
)
